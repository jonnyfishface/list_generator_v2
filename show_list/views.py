...
def home(request):
	return render(request, 'show_list/home.html', {'sausage':'this text will appear whenever you write sausage'})
...
def list(request):
	...
	return render(request, 'show_list/list.html', {'list':thelist})